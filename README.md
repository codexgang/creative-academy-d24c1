...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://api.stackbit.com/pull/601d24c16dd9f2001621e24a
...
To start editing your site, you can use the Sanity interface at https://interesting-goose-d24c1.sanity.studio/.
...
Generated at `2021-02-05T11:01:57.511Z` by Stackbit version `0.3.47`.